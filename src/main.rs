...
fn main() {
    ...
    let cam = camera::Camera::new(
        ...
        &scene_dat.vup,
        scene_dat.vfov,
        scene_dat.aspect_ratio,
        scene_dat.aperture,
        scene_dat.dist_to_focus,
        0.0,
        1.0,
    );

    //Image
    let mut img = Picture::new(
        scene_dat.image_width,
        scene_dat.aspect_ratio,
        scene_dat.sample_per_pixel,
        &String::from(outname),
        outtype,
    )
    .expect("Error making image");
